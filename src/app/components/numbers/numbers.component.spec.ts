...
describe('roman-numerals-service test', () => {  
  describe('Tests from 1 to 100', () => {    
    //1
    it('should return a message', () => {
      expect(rms.aRomano(0)).toEqual("Número por fuera de los limites");
    })
  ...
  describe('Tests from 101 to 200', () => {
    ///101 a 103
  ...
  describe('Tests from 301 from 400', () => {
  ...
  describe('Test from 901 to 1000', () => {
    ...
    it('should return a message', () => {
      expect(rms.aRomano(1001)).toEqual("Número por fuera de los limites");
    })
  })
})